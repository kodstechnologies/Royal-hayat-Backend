...
const optionalStringList = Joi.array()
...
const createJobSchema = Joi.object({
  ...
  arabicClassification: Joi.string().trim().max(100).optional().allow(''),
  ...
  educationAndLicensure: optionalStringList,
  arabicEducationAndLicensure: optionalStringList,
  professionalExperience: optionalStringList,
  arabicProfessionalExperience: optionalStringList,
  specializedKnowledge: optionalStringList,
  arabicSpecializedKnowledge: optionalStringList,
